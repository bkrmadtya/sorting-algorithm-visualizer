...
const SortingAlgorithm: FC = () => {
  return (
    <>
      ...
      <ol>
        <li>
          <strong>Comparison/Non-comparison-based sorting: </strong>A sorting is
        ...
        <li>
          <strong>In-place/Out-place sorting: </strong>A sorting is in-place
          sorting if it does not use extra memory to sort the array otherwise,
          it is out-place sorting.
        </li>
        <li>
          <strong>Online/Offline sorting: </strong>A sorting is online sorting
        ...
        <li>
          <strong>Stable/Unstable sorting: </strong>A sorting is stable sorting
